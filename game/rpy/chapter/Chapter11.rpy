...
label Chapter11:
    ...
    aki_Death "许愿最重要的是，许下愿望的那一瞬间，那一瞬间的祈祷也好，哀怨也罢，是真实存在的，是真正抓住了那一瞬间的心里所想。实不实现也许，没那么重要。\n（笑容）快点快点！随便许个愿吧"
    menu:
            "想要继续活着":
    ...
    aki_Death "西西弗斯？那个推石头的吗？\n有人曾和我说过，应当想象西西弗斯是幸福的，他不止是在推石头上山顶，而是在一次又一次地攀登顶峰，而攀登山顶的拼搏本身就足以充实一颗人心。\n真是好笑，用虚无填满的人心，不仍然是虚无吗？"
    mir "你这家伙，长得像Aki，声音也像Aki，唯独性格，比Aki差多了。"
    aki_Death "（惆怅特写）脸长的一样，声音也像，这不就够了吗？性格再相似的话，我是不是就能成为Aki了，不去改变自己的性格，靠你欺骗自己，我也能成为Aki不是吗？到那时，对AKi的爱是否能分我一些呢？爱我是不是就等同于爱AKi呢？"
